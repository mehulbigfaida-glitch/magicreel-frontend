...
export default function ReelOutputPage() {
  ...
  return <div className="carousel-reel-page"><div className="carousel-reel-orb carousel-reel-orb-one"/><div className="carousel-reel-orb carousel-reel-orb-two"/><main className="carousel-reel-shell">
    ...
    <section className="carousel-reel-hero">
      ...
      <aside className="carousel-reel-right"><h2>From Every Angle<br/>to Every Audience</h2><p className="carousel-reel-right-intro">Turn your product into a story.</p><div className="carousel-reel-benefit"><span>◉</span><div><strong>Cinematic Transitions</strong><p>Smooth motion, directional reveals and elegant rhythm for a premium look.</p></div></div><div className="carousel-reel-benefit"><span>✦</span><div><strong>Showcase Every Detail</strong><p>Highlight fit, fabric and design from multiple angles.</p></div></div><div className="carousel-reel-benefit"><span>⌯</span><div><strong>Ready to Share</strong><p>Perfect for social media, ads and marketplaces.</p></div></div><div className="carousel-reel-benefit"><span>♡</span><div><strong>Made for Fashion Brands</strong><p>Professional reels in seconds with AI.</p></div></div><div className="carousel-reel-signoff">Showcase Style<br/>Create Impact</div></aside>
    </section>
